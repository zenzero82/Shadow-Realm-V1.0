...
extern const u8 EventScript_OverworldWildMon[];
...
extern const u8 Kanto_Furniture_EventScript_TV_Pallet[];
extern const u8 Kanto_Furniture_EventScript_TV_Viridian[];
extern const u8 Kanto_Furniture_EventScript_TV_Pewter[];
extern const u8 Kanto_Furniture_EventScript_TV_Cerulean[];
extern const u8 Kanto_Furniture_EventScript_TV_Lavender[];
extern const u8 RouteHouse_Furniture_EventScript_TV[];
...
extern const u8 Kanto_Furniture_EventScript_Bookshelf_Pallet[];
extern const u8 Kanto_Furniture_EventScript_Bookshelf_Viridian[];
extern const u8 Kanto_Furniture_EventScript_Bookshelf_Pewter[];
extern const u8 Kanto_Furniture_EventScript_Bookshelf_Cerulean[];
extern const u8 Kanto_Furniture_EventScript_Bookshelf_Lavender[];
extern const u8 RouteHouse_Furniture_EventScript_Bookshelf_Kanto[];
extern const u8 RouteHouse_Furniture_EventScript_Bookshelf_Johto[];
