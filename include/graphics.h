...
extern const u32 gBattleEnvironmentTiles_RockGym[];
extern const u32 gBattleEnvironmentTilemap_RockGym[];
extern const u16 gBattleEnvironmentPalette_RockGym[];
extern const u32 gBattleEnvironmentTiles_BrockGym[];
extern const u32 gBattleEnvironmentTilemap_BrockGym[];
extern const u16 gBattleEnvironmentPalette_BrockGym[];
extern const u32 gBattleEnvironmentTiles_GymNeutralBg[];
extern const u32 gBattleEnvironmentTilemap_GymNeutralBg[];
extern const u16 gBattleEnvironmentPalette_GymNeutralBg[];
extern const u16 gBattleEnvironmentPalette_GymNeutralBg_Rock[];
extern const u16 gBattleEnvironmentPalette_GymNeutralBg_Water[];
extern const u16 gBattleEnvironmentPalette_GymNeutralBg_Flying[];
extern const u16 gBattleEnvironmentPalette_GymNeutralBg_Bug[];
extern const u16 gBattleEnvironmentPalette_GymNeutralBg_Grass[];
extern const u16 gBattleEnvironmentPalette_GymNeutralBg_Electric[];
extern const u16 gBattleEnvironmentPalette_GymNeutralBg_Normal[];
extern const u16 gBattleEnvironmentPalette_GymNeutralBg_Ground[];
...
extern const u16 gPokedexShadowmonitor_Pal[];
...
extern const u16 gPokedexHgssDefault_Pal[];
extern const u16 gPokedexHgssNational_Pal[];
extern const u16 gPokedexHgssSearchMenu_Pal[];
extern const u16 gPokedexHgssSearchResults_Pal[];
extern const u32 gPokedexHgssMenuList_Gfx[];
extern const u32 gPokedexHgssList_Tilemap[];
extern const u32 gPokedexHgssListUnderlay_Tilemap[];
extern const u32 gPokedexHgssStartMenuMain_Tilemap[];
extern const u32 gPokedexHgssStartMenuSearchResults_Tilemap[];
extern const u32 gPokedexHgssSearchMenu_Gfx[];
extern const u32 gPokedexHgssSearchMenuHoenn_Tilemap[];
extern const u32 gPokedexHgssSearchMenuNational_Tilemap[];
...
extern const u32 gItemIcon_ShadowMonitor[];
extern const u16 gItemIconPalette_ShadowMonitor[];
extern const u32 gItemIcon_QuestJournal[];
extern const u16 gItemIconPalette_QuestJournal[];
...
extern const u32 gItemIcon_TimeFlute[];
extern const u16 gItemIconPalette_TimeFlute[];
extern const u32 gItemIcon_RelicTablet[];
extern const u16 gItemIconPalette_RelicTablet[];
...
extern const u32 gItemIcon_TunnelKey[];
extern const u16 gItemIconPalette_TunnelKey[];
extern const u32 gItemIcon_CardKeySilphCo[];
extern const u16 gItemIconPalette_CardKeySilphCo[];
extern const u32 gItemIcon_CardKeyRadioTower[];
extern const u16 gItemIconPalette_CardKeyRadioTower[];
extern const u32 gItemIcon_CologneCase[];
extern const u16 gItemIconPalette_CologneCase[];
...
// start menu BW graphics
extern const u8 gStartMenuBWBgTiles[];
extern const u16 gStartMenuBWBgPal[];
extern const u16 gStartMenuBWBgTilemap[];
extern const u8 gStartMenuBWPanelTiles[];
extern const u16 gStartMenuBWPanelPal[];
extern const u8 gStartMenuBWExitTiles[];
extern const u16 gStartMenuBWExitPal[];
extern const u8 gStartMenuBWScrollBarTiles[];
extern const u16 gStartMenuBWScrollBarPal[];
extern const u8 gStartMenuBWPokedexTiles[];
extern const u16 gStartMenuBWPokedexPal[];
extern const u8 gStartMenuBWDexnavTiles[];
extern const u16 gStartMenuBWDexnavPal[];
extern const u8 gStartMenuBWPokemonTiles[];
extern const u16 gStartMenuBWPokemonPal[];
extern const u8 gStartMenuBWBagTiles[];
extern const u16 gStartMenuBWBagPal[];
extern const u8 gStartMenuBWPokenavTiles[];
extern const u16 gStartMenuBWPokenavPal[];
extern const u8 gStartMenuBWPlayerTiles[];
extern const u16 gStartMenuBWPlayerPal[];
extern const u8 gStartMenuBWSaveTiles[];
extern const u16 gStartMenuBWSavePal[];
extern const u8 gStartMenuBWOptionsTiles[];
extern const u16 gStartMenuBWOptionsPal[];
extern const u8 gStartMenuBWExitOptionTiles[];
extern const u16 gStartMenuBWExitOptionPal[];
extern const u8 gStartMenuBWRetireTiles[];
extern const u16 gStartMenuBWRetirePal[];
extern const u8 gStartMenuBWDebugTiles[];
extern const u16 gStartMenuBWDebugPal[];
...
extern const u16 gPokenavLeftHeaderKantoMap_Pal[];
extern const u16 gPokenavLeftHeaderJohtoMap_Pal[];
...
extern const u32 gSummaryScreen_Gfx_Shadow[];
...
extern const u16 gJohtoTrainerCardGold_Pal[];
