...
enum StringID
{
    ...
    STRINGID_SHADOW_POKEMON_SPOTTED,
    ...
    STRINGID_TRAINERCALLTOMON,
    STRINGID_PKMNSTOREDEXP,
    STRINGID_PKMNHEARTGAUGEUPDATE,
    STRINGID_STARTEDSHADOW_SKY,
    STRINGID_SHADOW_SKYCONTINUES,
    STRINGID_SHADOW_SKYSTOPPED,
    STRINGID_SHADOW_SKYDAMAGE,
    STRINGID_REVERSEMODE_ENTER,
    STRINGID_REVERSEMODE_DAMAGE,
    STRINGID_REVERSEMODE_CALLED,
    STRINGID_GOTCHAPKMNCAUGHTTRAINER,
    STRINGID_TRAINERCALLEDTOMON,
    STRINGID_SHADOWCALMEDSLIGHTLY,      
    STRINGID_SHADOWCAMETOSENSES,       
    STRINGID_TRAINERENCOURAGEDMON,
    STRINGID_COUNT
};
...
enum CaughtMonStringID
{
    ...
    // "Jinwoo's" and "Lanette's" should always follow "someone's"
    B_MSG_SENT_SOMEONES_PC,
    B_MSG_SENT_JINWOOS_PC,
    B_MSG_SENT_LANETTES_PC,
    B_MSG_SOMEONES_BOX_FULL,
    B_MSG_JINWOOS_BOX_FULL,
