...
#define BAG_BATTLE_ITEMS_COUNT 30
#define BAG_KEYITEMS_COUNT 30
#define BAG_TREASURES_COUNT 40
#define BAG_POKEBALLS_COUNT 16
#define BAG_TMHM_COUNT 229
...
#define OPTIONS_SHINY_ODDS_COUNT 5

#define OPTIONS_LEVEL_CAP_OFF 0
#define OPTIONS_LEVEL_CAP_NORMAL 1
#define OPTIONS_LEVEL_CAP_HARD 2
#define OPTIONS_OVERWORLD_WILD_OFF 0
#define OPTIONS_OVERWORLD_WILD_ON 1
#define OPTIONS_OVERWORLD_WILD_COUNT 2
#define OPTIONS_AUTOSAVE_OFF 0
#define OPTIONS_AUTOSAVE_ON 1
#define OPTIONS_AUTOSAVE_COUNT 2
#define OPTIONS_AUTO_RUN_OFF 0
#define OPTIONS_AUTO_RUN_ON 1
#define OPTIONS_AUTO_RUN_COUNT 2
#define OPTIONS_EV_IV_EDITOR_OFF 0
#define OPTIONS_EV_IV_EDITOR_ON 1
#define OPTIONS_EV_IV_EDITOR_COUNT 2
