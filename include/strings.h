...
extern const u8 gText_CanNotUseAtThisTime[];
...
extern const u8 gText_HoennCard[];
extern const u8 gText_KantoCard[];
extern const u8 gText_JohtoCard[];
extern const u8 gText_TrainerCardSwitchHint[];
extern const u8 gText_PokedollarVar1[];
