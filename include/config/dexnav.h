...
// Flag/var defines
#define DN_FLAG_SEARCHING             0x28A // Searching for mon (FLAG_DEXNAV_SEARCHING)
#define DN_FLAG_DEXNAV_GET            0x28B // DexNav shows in start menu (FLAG_DEXNAV_GET)
#define DN_FLAG_DETECTOR_MODE         0x28C // Allow player to find hidden mons (FLAG_DEXNAV_DETECTOR_MODE)
#define DN_VAR_SPECIES                0x4083 // Registered DexNav species (VAR_DEXNAV_SPECIES)
#define DN_VAR_STEP_COUNTER           0x408B // Steps for finding hidden pokemon (VAR_DEXNAV_STEP_COUNTER)
