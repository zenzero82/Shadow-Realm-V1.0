...
static const struct PikeRoomNPC sNPCTable[] =
{
    ...
    {
        .graphicsId = OBJ_EVENT_GFX_POKEMON_RANGER_F,
        .speechId1 = 13,
        .speechId2 = 39,
        .speechId3 = 21
    },
    {
        .graphicsId = OBJ_EVENT_GFX_LADY,
        .speechId1 = 2,
        .speechId2 = 4,
        .speechId3 = 17
    },
    ...
    {
        .graphicsId = OBJ_EVENT_GFX_PARASOL_LADY,
        .speechId1 = 5,
        .speechId2 = 22,
        .speechId3 = 4
    },
...
static void SetupRoomObjectEvents(void)
{
    ...
    VarSet(VAR_OBJ_GFX_ID_1, OBJ_EVENT_GFX_GENTLEMAN);
    setObjGfx1 = TRUE;
    setObjGfx2 = FALSE;
    objGfx1 = 0;
    objGfx2 = 0;
    ...
    case PIKE_ROOM_STATUS:
        ...
        if (sStatusMon == PIKE_STATUSMON_DUSCLOPS)
            objGfx2 = OBJ_EVENT_GFX_GENTLEMAN;
        else
            objGfx2 = OBJ_EVENT_GFX_LASS;
        setObjGfx2 = TRUE;
        break;
