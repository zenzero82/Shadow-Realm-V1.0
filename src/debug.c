...
static void DebugAction_Give_PokemonSimple(u8 taskId)
{
    ...
    gTasks[taskId].tSpriteId = CreateMonIcon(gTasks[taskId].tInput, SpriteCB_MonIcon, DEBUG_NUMBER_ICON_X, DEBUG_NUMBER_ICON_Y, 4, 0, FALSE, FALSE);
    gSprites[gTasks[taskId].tSpriteId].oam.priority = 0;
}
...
static void DebugAction_PCBag_Fill_PocketTMHM(u8 taskId)
{
    ...
    for (itemId = ITEM_TM01; itemId < ITEM_TM01 + NUM_TECHNICAL_MACHINES; itemId++)
    {
