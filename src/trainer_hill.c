...
} static const sTrainerClassesAndMusic[] =
{
    ...
    {TRAINER_CLASS_CIPHER_PEON, TRAINER_ENCOUNTER_MUSIC_CIPHER_PEON},
    {TRAINER_CLASS_TEAM_ROCKET, TRAINER_ENCOUNTER_MUSIC_TEAM_ROCKET},
    {TRAINER_CLASS_TEAM_GALACTIC, TRAINER_ENCOUNTER_MUSIC_GALACTIC},
    {TRAINER_CLASS_TEAM_PLASMA, TRAINER_ENCOUNTER_MUSIC_PLASMA},
