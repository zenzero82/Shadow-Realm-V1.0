...
static const u8 sText_PlayerDefeatedLinkTrainerTrainer1[] = _("You defeated\n{B_TRAINER1_NAME_WITH_CLASS}!\p");
...
static const u8 sText_Trainer1WantsToBattle[] = _("You are challenged by\n{B_TRAINER1_NAME_WITH_CLASS}!\p");
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_SHADOW_POKEMON_FLED_TRAINER]          = sText_ShadowPokemonFledTrainer,
    [STRINGID_SHADOW_POKEMON_FLED_GENERIC]          = sText_ShadowPokemonFledGeneric,
    ...
    [STRINGID_PLAYERLOSTTOENEMYTRAINER]             = COMPOUND_STRING("You have no more Pokémon that can fight!\pYou lost to\n{B_TRAINER1_NAME_WITH_CLASS}!{PAUSE_UNTIL_PRESS}"),
...
static const u8 sText_PlayerLostAgainstTrainer1[] = _("You lost to\n{B_TRAINER1_NAME_WITH_CLASS}!");
static const u8 sText_PlayerBattledToDrawTrainer1[] = _("You battled to a draw\nagainst {B_TRAINER1_NAME_WITH_CLASS}!");
