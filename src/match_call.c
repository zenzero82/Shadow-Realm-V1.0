...
static const struct MatchCallTrainerTextInfo sMatchCallTrainers[REMATCH_TABLE_ENTRIES] =
{
    [0] = {
        .trainerId = TRAINER_SHADOW_TEST,
        .unused = 0,
        .battleTopicTextIds = BATTLE_TEXT_IDS(0),
        .generalTextId = TEXT_ID(GEN_TOPIC_PERSONAL, 1),
        .battleFrontierRecordStreakTextIndex = 0,
        .sameRouteMatchCallTextId = TEXT_ID(REQ_TOPIC_SAME_ROUTE, 0),
        .differentRouteMatchCallTextId = TEXT_ID(REQ_TOPIC_DIFF_ROUTE, 0),
    },
};
...
{
    { .trainerId = TRAINER_SHADOW_TEST, .text = gText_EmptyString2 },
};
