...
const u32 gSummaryScreen_Gfx_Shadow[]         = INCBIN_U32("graphics/summary_screen/iv_ev_tiles_shadow.4bpp.lz");
...
const u16 gPokedexShadowmonitor_Pal[] = INCBIN_U16("graphics/pokedex/shadowmonitor.gbapal");
...
const u16 gPokedexHgssDefault_Pal[] = INCBIN_U16("graphics/pokedex/hgss/palette_default.gbapal");
const u16 gPokedexHgssNational_Pal[] = INCBIN_U16("graphics/pokedex/hgss/palette_national.gbapal");
const u16 gPokedexHgssSearchMenu_Pal[] = INCBIN_U16("graphics/pokedex/hgss/palette_search_menu.gbapal");
const u16 gPokedexHgssSearchResults_Pal[] = INCBIN_U16("graphics/pokedex/hgss/palette_search_results.gbapal");
const u32 gPokedexHgssMenuList_Gfx[] = INCBIN_U32("graphics/pokedex/hgss/tileset_menu_list.4bpp.lz");
const u32 gPokedexHgssList_Tilemap[] = INCBIN_U32("graphics/pokedex/hgss/tilemap_list_screen.bin.lz");
const u32 gPokedexHgssListUnderlay_Tilemap[] = INCBIN_U32("graphics/pokedex/hgss/tilemap_list_screen_underlay.bin.lz");
const u32 gPokedexHgssStartMenuMain_Tilemap[] = INCBIN_U32("graphics/pokedex/hgss/tilemap_start_menu.bin.lz");
const u32 gPokedexHgssStartMenuSearchResults_Tilemap[] = INCBIN_U32("graphics/pokedex/hgss/tilemap_start_menu_search_results.bin.lz");
const u32 gPokedexHgssSearchMenu_Gfx[] = INCBIN_U32("graphics/pokedex/hgss/tileset_menu_search.4bpp.lz");
const u32 gPokedexHgssSearchMenuHoenn_Tilemap[] = INCBIN_U32("graphics/pokedex/hgss/tilemap_search_screen_hoenn.bin.lz");
const u32 gPokedexHgssSearchMenuNational_Tilemap[] = INCBIN_U32("graphics/pokedex/hgss/tilemap_search_screen_national.bin.lz");
...
// Start menu (BW)
const u8 gStartMenuBWBgTiles[] = INCBIN_U8("graphics/start_menu_bw/bg.4bpp");
const u16 gStartMenuBWBgPal[] = INCBIN_U16("graphics/start_menu_bw/bg.gbapal");
const u16 gStartMenuBWBgTilemap[] = INCBIN_U16("graphics/start_menu_bw/bg.bin");

const u8 gStartMenuBWPanelTiles[] = INCBIN_U8("graphics/start_menu_bw/sprites/panel.4bpp");
const u16 gStartMenuBWPanelPal[] = INCBIN_U16("graphics/start_menu_bw/sprites/panel.gbapal");
const u8 gStartMenuBWExitTiles[] = INCBIN_U8("graphics/start_menu_bw/sprites/exit.4bpp");
const u16 gStartMenuBWExitPal[] = INCBIN_U16("graphics/start_menu_bw/sprites/exit.gbapal");
const u8 gStartMenuBWScrollBarTiles[] = INCBIN_U8("graphics/start_menu_bw/sprites/scrollbar.4bpp");
const u16 gStartMenuBWScrollBarPal[] = INCBIN_U16("graphics/start_menu_bw/sprites/scrollbar.gbapal");
const u8 gStartMenuBWPokedexTiles[] = INCBIN_U8("graphics/start_menu_bw/sprites/pokedex.4bpp");
const u16 gStartMenuBWPokedexPal[] = INCBIN_U16("graphics/start_menu_bw/sprites/pokedex.gbapal");
const u8 gStartMenuBWDexnavTiles[] = INCBIN_U8("graphics/start_menu_bw/sprites/dexnav.4bpp");
const u16 gStartMenuBWDexnavPal[] = INCBIN_U16("graphics/start_menu_bw/sprites/dexnav.gbapal");
const u8 gStartMenuBWPokemonTiles[] = INCBIN_U8("graphics/start_menu_bw/sprites/pokemon.4bpp");
const u16 gStartMenuBWPokemonPal[] = INCBIN_U16("graphics/start_menu_bw/sprites/pokemon.gbapal");
const u8 gStartMenuBWBagTiles[] = INCBIN_U8("graphics/start_menu_bw/sprites/bag.4bpp");
const u16 gStartMenuBWBagPal[] = INCBIN_U16("graphics/start_menu_bw/sprites/bag.gbapal");
const u8 gStartMenuBWPokenavTiles[] = INCBIN_U8("graphics/start_menu_bw/sprites/pokenav.4bpp");
const u16 gStartMenuBWPokenavPal[] = INCBIN_U16("graphics/start_menu_bw/sprites/pokenav.gbapal");
const u8 gStartMenuBWPlayerTiles[] = INCBIN_U8("graphics/start_menu_bw/sprites/player.4bpp");
const u16 gStartMenuBWPlayerPal[] = INCBIN_U16("graphics/start_menu_bw/sprites/player.gbapal");
const u8 gStartMenuBWSaveTiles[] = INCBIN_U8("graphics/start_menu_bw/sprites/save.4bpp");
const u16 gStartMenuBWSavePal[] = INCBIN_U16("graphics/start_menu_bw/sprites/save.gbapal");
const u8 gStartMenuBWOptionsTiles[] = INCBIN_U8("graphics/start_menu_bw/sprites/options.4bpp");
const u16 gStartMenuBWOptionsPal[] = INCBIN_U16("graphics/start_menu_bw/sprites/options.gbapal");
const u8 gStartMenuBWExitOptionTiles[] = INCBIN_U8("graphics/start_menu_bw/sprites/exit_option.4bpp");
const u16 gStartMenuBWExitOptionPal[] = INCBIN_U16("graphics/start_menu_bw/sprites/exit_option.gbapal");
const u8 gStartMenuBWRetireTiles[] = INCBIN_U8("graphics/start_menu_bw/sprites/retire.4bpp");
const u16 gStartMenuBWRetirePal[] = INCBIN_U16("graphics/start_menu_bw/sprites/retire.gbapal");
const u8 gStartMenuBWDebugTiles[] = INCBIN_U8("graphics/start_menu_bw/sprites/debug.4bpp");
const u16 gStartMenuBWDebugPal[] = INCBIN_U16("graphics/start_menu_bw/sprites/debug.gbapal");
...
const u16 sNameBox_Pal[] = INCBIN_U16("graphics/text_window/name_box.gbapal");
