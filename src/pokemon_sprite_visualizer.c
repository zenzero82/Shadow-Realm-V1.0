...
void CB2_Pokemon_Sprite_Visualizer(void)
{
    ...
    switch (gMain.state)
    {
        ...
        case 3:
            ...
            //Icon Sprite
            data->iconspriteId = CreateMonIcon(species, SpriteCB_MonIcon, VISUALIZER_ICON_X, VISUALIZER_ICON_Y, 4, (data->isFemale ? FEMALE_PERSONALITY : MALE_PERSONALITY), data->isShiny, FALSE);
