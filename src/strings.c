...
const u8 gText_ShadowPokemonCantBreed[] = _("Shadow POKéMON can't breed.{PAUSE_UNTIL_PRESS}");
const u8 gText_ShadowPokemonCantLearnMoves[] = _("Shadow POKéMON can't learn\nmoves.{PAUSE_UNTIL_PRESS}");
const u8 gText_TimeFluteShadowOnly[] = _("The Time Flute only works on\nShadow POKéMON.{PAUSE_UNTIL_PRESS}");
const u8 gText_OhThatsShadowPokemon[] = _("Oh! That has to be a Shadow\nPOKéMON!");
