...
const u8 gText_ShadowPokemonCantBreed[] = _("{COLOR PURPLE}Shadow POKéMON{COLOR DARK_GRAY} can't breed.{PAUSE_UNTIL_PRESS}");
const u8 gText_ShadowPokemonCantLearnMoves[] = _("{COLOR PURPLE}Shadow POKéMON{COLOR DARK_GRAY} can't learn\nmoves.{PAUSE_UNTIL_PRESS}");
const u8 gText_TimeFluteShadowOnly[] = _("The {COLOR GREEN}Time Flute{COLOR DARK_GRAY} only works on\n{COLOR PURPLE}Shadow POKéMON{COLOR DARK_GRAY}.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_OhThatsShadowPokemon[] = _("Oh! That has to be a {COLOR PURPLE}Shadow\nPOKéMON{COLOR DARK_GRAY}!");
