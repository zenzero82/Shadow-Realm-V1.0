...
const u8 gText_BagAutoSort[] = _("AUTO SORT");
const u8 gText_BagFavorites[] = _("FAVORITES");
const u8 gText_BagSortNameAZ[] = _("NAME A-Z");
const u8 gText_BagSortNameZA[] = _("NAME Z-A");
const u8 gText_BagSortType[] = _("SORT BY TYPE");
const u8 gText_BagFavoritesAdd[] = _("ADD FAVORITES");
const u8 gText_BagFavoritesRemove[] = _("REMOVE FAVORITES");
const u8 gText_BagFavoritesSort[] = _("SORT BY FAVORITES");
const u8 gText_BagFavoritesAddHint[] = _("Select items to\nfavorite.\nPress B to finish.");
const u8 gText_BagFavoritesRemoveHint[] = _("Select favorites to\nremove.\nPress B to finish.");
const u8 gText_BagFavoritesFull[] = _("Favorites list is full.");
...
const u8 gText_DadsAdvice[] = _("I don't think this is the right\ntime to use this...{PAUSE_UNTIL_PRESS}");
...
const u8 *const gPocketNamesStringsTable[] =
{
    ...
    [TMHM_POCKET] =          COMPOUND_STRING("TMs"),
    [BERRIES_POCKET] =       COMPOUND_STRING("BERRIES"),
    [BATTLE_ITEMS_POCKET] =  COMPOUND_STRING("BATTLE ITEM"),
...
const u8 gText_NoValidItemsInBag[] = _("No valid items in bag.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_CanNotUseAtThisTime[] = _("Can not use at this time.");
const u8 gText_ShadowPokemonCantBreed[] = _("{COLOR BLUE}Shadow POKéMON{COLOR DARK_GRAY} can't breed.{PAUSE_UNTIL_PRESS}");
const u8 gText_ShadowPokemonCantLearnMoves[] = _("{COLOR BLUE}Shadow POKéMON{COLOR DARK_GRAY} can't learn\nmoves.{PAUSE_UNTIL_PRESS}");
const u8 gText_TimeFluteShadowOnly[] = _("The {COLOR GREEN}Time Flute{COLOR DARK_GRAY} only works on\n{COLOR BLUE}Shadow POKéMON{COLOR DARK_GRAY}.{PAUSE_UNTIL_PRESS}");
const u8 gText_RelicTabletShadowOnly[] = _("The {COLOR GREEN}Relic Tablet{COLOR DARK_GRAY} only works on\n{COLOR BLUE}Shadow POKéMON{COLOR DARK_GRAY}.{PAUSE_UNTIL_PRESS}");
const u8 gText_RelicTabletNotReady[] = _("This POKéMON's heart\nis still shut!{PAUSE_UNTIL_PRESS}");
const u8 gText_ShadowCologneShadowOnly[] = _("That scent only works on\n{COLOR BLUE}Shadow POKéMON{COLOR DARK_GRAY}.{PAUSE_UNTIL_PRESS}");
const u8 gText_CologneCaseEmpty[] = _("The Cologne Case is empty.{PAUSE_UNTIL_PRESS}");
const u8 gText_ChooseAScent[] = _("Choose a scent.");
const u8 gText_NoScentsLeft[] = _("There are no more of that scent left.{PAUSE_UNTIL_PRESS}");
const u8 gText_UsedVar2OnVar1[] = _("{PLAYER} used the\n{STR_VAR_2} on {STR_VAR_1}.{PAUSE_UNTIL_PRESS}");
const u8 gText_ZygardeCubeCounts[] = _("Cells: {STR_VAR_1}\nCores: {STR_VAR_2}.{PAUSE_UNTIL_PRESS}");
const u8 gText_ZygardeCubeNeedCells[] = _("The Zygarde Cube needs\nmore Cells.{PAUSE_UNTIL_PRESS}");
const u8 gText_OhThatsShadowPokemon[] = _("Oh! That has to be a {COLOR BLUE}Shadow\nPOKéMON{COLOR DARK_GRAY}!");
...
const u8 gText_JinwoosPC[] = _("JINWOO'S PC");
...
const u8 gText_HoennCard[] = _("HOENN CARD");
const u8 gText_KantoCard[] = _("KANTO CARD");
const u8 gText_JohtoCard[] = _("JOHTO CARD");
const u8 gText_TrainerCardSwitchHint[] = _("D-PAD L/R TO SWITCH CARDS");
...
const u8 gText_SelectorArrow3[] = _("{COLOR_HIGHLIGHT_SHADOW WHITE TRANSPARENT LIGHT_GRAY}▶");
...
const u8 gText_StartMenu_Sun[] = _("SUN");
const u8 gText_StartMenu_Mon[] = _("MON");
const u8 gText_StartMenu_Tue[] = _("TUE");
const u8 gText_StartMenu_Wed[] = _("WED");
const u8 gText_StartMenu_Thu[] = _("THU");
const u8 gText_StartMenu_Fri[] = _("FRI");
const u8 gText_StartMenu_Sat[] = _("SAT");
const u8 gText_StartMenu_AM[] = _("AM");
const u8 gText_StartMenu_PM[] = _("PM");
const u8 gText_StartMenu_TimeBase_12Hr[] = _("{STR_VAR_3} {STR_VAR_1}:{STR_VAR_2}");
const u8 gText_StartMenu_SafariZoneStats[] = _("BALLS: {STR_VAR_1}   {STR_VAR_2}/600");
...
const u8 gText_AlphabetUpperLower[] = _("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz");
const u8 gText_RivalsName[] = _("RIVAL'S NAME?");
const u8 gText_MonSentToBoxInSomeonesPC[] = _("Sent to someone's PC.");
const u8 gText_MonSentToBoxInJinwoosPC[] = _("Sent to Jinwoo's PC.");
const u8 gText_MonSentToBoxInLanettesPC[] = _("Sent to Lanette's PC.");
const u8 gText_MonSentToBoxInBillsPC[] = _("Sent to Bill's PC.");
const u8 gText_MonSentToBoxSomeonesBoxFull[] = _("Someone's box is full.");
const u8 gText_MonSentToBoxJinwoosBoxFull[] = _("Jinwoo's box is full.");
const u8 gText_MonSentToBoxLanettesBoxFull[] = _("Lanette's box is full.");
const u8 gText_MonSentToBoxBillsBoxFull[] = _("Bill's box is full.");
...
const u8 gText_InputGiftCode[] = _("Input a Gift Code.");
const u8 gText_ZenwoosBlessingCodeInvalid[] = _("That Gift Code is invalid.");
const u8 gText_ZenwoosBlessingCodeUsed[] = _("That Gift Code has already\nbeen used on this save file.");
const u8 gText_ZenwoosBlessingCodeSuccess[] = _("Success! Visit a Pokemon\nCenter to redeem your gift.");
...
const u8 gText_TurnOnExpShare[] = _("Turn the Exp. Share on?");
const u8 gText_TurnOffExpShare[] = _("Turn the Exp. Share off?");
