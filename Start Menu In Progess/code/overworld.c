...
extern const u8 EventScript_ShadowPurifyReadyMultiple[];
...
void CB2_ReturnToFieldContinueScriptPlayMapMusic(void)
{
    ...
    {
        if (gShadowPurifyReadyMonCount > 1)
            ScriptContext_SetupScript(EventScript_ShadowPurifyReadyMultiple);
        else
